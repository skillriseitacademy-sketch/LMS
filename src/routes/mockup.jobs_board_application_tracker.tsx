...
function JobsBoardApplicationTrackerPage() {
  return (
    <>
      <nav className="hidden md:flex flex-col h-full py-6 px-4 w-sidebar-width overflow-y-auto bg-surface-container-lowest shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] z-50 flex-shrink-0">
        ...
        <div className="flex-1 space-y-sm">
          ...
          <a
            className="flex items-center gap-4 px-4 py-2 rounded-lg text-primary font-bold border-r-4 border-primary bg-surface-container-low active:scale-[0.98] transition-transform duration-150"
            href="#"
          >
        ...
        <div className="mt-auto space-y-sm pt-4 border-t border-surface-container-high">
          <button className="w-full bg-primary text-on-primary py-2 rounded-lg font-label-sm text-label-sm hover:bg-primary-container transition-colors active:scale-[0.98]">
            Start Practice
          </button>
          <a
            className="flex items-center gap-4 px-4 py-2 rounded-lg text-on-surface-variant hover:text-primary hover:bg-surface-container transition-colors duration-200"
          ...
          <a
            className="flex items-center gap-4 px-4 py-2 rounded-lg text-on-surface-variant hover:text-error hover:bg-error-container transition-colors duration-200"
            href="#"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="flex justify-between items-center px-8 w-full h-16 z-40 bg-surface/80 backdrop-blur-md flex-shrink-0">
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <div className="w-8 h-8 rounded-full overflow-hidden ml-2 border-2 border-surface-container-highest">
              <img
                alt="Student Avatar"
        ...
        <main className="flex-1 overflow-x-auto overflow-y-hidden p-8">
          <div className="mb-6 flex justify-between items-end">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 bg-surface-container-lowest border border-outline-variant rounded-lg text-on-surface font-label-sm text-label-sm hover:bg-surface-container-low transition-colors flex items-center gap-2">
                <span className="material-symbols-outlined text-sm">filter_list</span> Filter
              </button>
              <button className="px-4 py-2 bg-primary text-on-primary rounded-lg font-label-sm text-label-sm hover:bg-primary-container active:scale-[0.98] transition-all flex items-center gap-2 shadow-sm">
                <span className="material-symbols-outlined text-sm">add</span> New App
              </button>
            </div>
          </div>

          <div className="flex gap-6 h-[calc(100%-80px)] pb-4">
            <div className="flex flex-col min-w-[320px] w-[320px] bg-surface-container/30 rounded-xl p-4 border border-surface-container-high kanban-col-bg">
              ...
              <div className="flex-1 overflow-y-auto space-y-md pr-2 custom-scrollbar">
                <div className="bg-surface-container-lowest p-4 rounded-xl shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] border-l-4 border-outline cursor-pointer hover:shadow-md transition-shadow group relative">
                  ...
                  <h3 className="font-body-md text-body-md font-semibold text-on-background mb-1">
                    Software Engineer, New Grad
                  </h3>
                  <p className="text-xs text-on-surface-variant mb-4 font-body-md line-clamp-1">
                    Mountain View, CA
                  </p>
                  <div className="pt-2 border-t border-surface-container-highest flex items-center justify-between">
            ...
            <div className="flex flex-col min-w-[320px] w-[320px] bg-surface-container/30 rounded-xl p-4 border border-surface-container-high kanban-col-bg">
              ...
              <div className="flex-1 overflow-y-auto space-y-md pr-2 custom-scrollbar">
                <div className="bg-surface-container-lowest p-4 rounded-xl shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] border-l-4 border-secondary-container cursor-pointer hover:shadow-md transition-shadow group relative">
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-1">
                  ...
                  <div className="p-2 bg-surface-container-lowest border border-outline-variant rounded-lg mb-2">
            ...
            <div className="flex flex-col min-w-[320px] w-[320px] bg-surface-container/30 rounded-xl p-4 border border-surface-container-high kanban-col-bg">
              ...
              <div className="flex-1 overflow-y-auto space-y-md pr-2 custom-scrollbar">
                <div className="bg-surface-container-lowest p-4 rounded-xl shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] border-l-4 border-primary cursor-pointer hover:shadow-md transition-shadow group relative">
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-1">
                  ...
                  <div className="p-2 bg-primary/5 border border-primary/20 rounded-lg mb-2">
            ...
            <div className="flex flex-col min-w-[320px] w-[320px] bg-surface-container/30 rounded-xl p-4 border border-surface-container-high kanban-col-bg">
              ...
              <div className="flex-1 overflow-y-auto space-y-md pr-2 custom-scrollbar flex items-center justify-center">
                <div className="text-center p-4 border-2 border-dashed border-outline-variant rounded-xl text-outline">
