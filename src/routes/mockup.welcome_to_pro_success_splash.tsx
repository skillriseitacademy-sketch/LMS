...
function WelcomeToProSuccessSplashPage() {
  return (
    <>
      ...
      <main className="relative z-10 w-full max-w-container-max px-4 md:px-xl mx-auto flex flex-col items-center text-center">
        ...
        <h1 className="font-display-lg text-display-lg text-on-surface mb-2 hidden md:block">
          Welcome to the Pro Tier, Alex!
        </h1>
        <h1 className="font-headline-lg-mobile text-headline-lg-mobile text-on-surface mb-2 md:hidden">
          Welcome to Pro, Alex!
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-3xl mb-8">
          <div className="bg-surface-container-lowest rounded-xl p-6 shadow-sm border border-surface-variant flex items-start text-left hover:border-primary transition-colors group">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center w-full md:w-auto">
          <button className="w-full md:w-auto bg-primary text-on-primary font-body-md font-semibold py-2 px-8 rounded-lg hover:bg-surface-tint scale-up-hover shadow-sm">
            Go to Dashboard
          </button>
