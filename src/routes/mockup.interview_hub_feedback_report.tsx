...
function InterviewHubFeedbackReportPage() {
  return (
    <>
      <nav className="hidden md:flex flex-col h-full py-6 px-4 w-sidebar-width overflow-y-auto bg-surface-container-lowest shadow-sm fixed left-0 top-0 h-full w-sidebar-width z-50">
        ...
        <div className="flex-1 flex flex-col gap-2">
          <a
            className="flex items-center gap-4 px-4 py-2 rounded-lg text-on-surface-variant hover:text-primary hover:bg-surface-container transition-colors duration-200 active:scale-[0.98]"
            href="#"
          >
          ...
          <a
            className="flex items-center gap-4 px-4 py-2 rounded-lg text-primary font-bold border-r-4 border-primary bg-surface-container-low transition-colors duration-200 active:scale-[0.98]"
            href="#"
          >
            <span
        ...
        <div className="mt-8 px-2 mb-6">
          <button className="w-full bg-primary text-on-primary font-label-sm text-label-sm uppercase py-4 rounded-lg shadow-sm hover:bg-primary-container transition-all active:scale-[0.98]">
            Start Practice
          </button>
        </div>

        <div className="border-t border-outline-variant/30 pt-6 flex flex-col gap-2">
          <a
            className="flex items-center gap-4 px-4 py-2 rounded-lg text-on-surface-variant hover:text-primary hover:bg-surface-container transition-colors duration-200 active:scale-[0.98]"
            href="#"
          >
          ...
          <a
            className="flex items-center gap-4 px-4 py-2 rounded-lg text-error hover:text-error hover:bg-error-container transition-colors duration-200 active:scale-[0.98]"
            href="#"
          >
      ...
      <main className="flex-1 md:ml-sidebar-width h-full overflow-y-auto bg-surface-bright relative">
        <header className="sticky top-0 z-40 bg-surface-bright/80 backdrop-blur-md px-8 py-4 flex justify-between items-center border-b border-outline-variant/10">
          ...
          <div className="flex items-center gap-4">
            <button className="flex items-center gap-2 bg-surface-container-high hover:bg-surface-variant text-primary font-label-sm text-label-sm px-4 py-2 rounded-full transition-colors">
        ...
        <div className="p-4 md:p-xl max-w-container-max mx-auto space-y-xl pb-24">
          <section className="flex flex-col lg:flex-row gap-8 items-start justify-between">
            ...
            <button className="flex items-center gap-2 bg-primary text-on-primary font-label-sm text-label-sm px-8 py-4 rounded-lg shadow-sm hover:bg-primary-container transition-all active:scale-[0.98] shrink-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="glass-card rounded-xl p-8 flex flex-col items-center justify-center text-center relative overflow-hidden group">
              <div className="absolute -top-20 -right-20 w-40 h-40 bg-primary/5 rounded-full blur-2xl"></div>
              <h4 className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider mb-6">
                Readiness Score
              </h4>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-surface-container-low rounded-full text-primary font-label-sm text-label-sm">
                <span className="material-symbols-outlined text-[16px]">trending_up</span>
                +5 from last interview
              </div>
            </div>

            <div className="lg:col-span-2 glass-card rounded-xl p-8 flex flex-col justify-between">
              ...
              <ul className="space-y-md">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <button className="mt-2 text-primary font-label-sm text-label-sm uppercase hover:underline flex items-center gap-1">
