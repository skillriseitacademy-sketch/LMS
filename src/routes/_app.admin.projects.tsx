      ...
      <div className="p-4 md:p-6 max-w-5xl mx-auto space-y-6">
        <header className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Manage the projects displayed on the public landing page.
            </p>
          </div>
          <button
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {projects.map((p) => (
            <div
              key={p.id}
              className="rounded-3xl border border-border bg-card overflow-hidden flex flex-col group"
            >
              <div className="aspect-video w-full overflow-hidden bg-muted relative">
                {p.imageUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-muted-foreground">
                    <FolderGit2 className="h-8 w-8 opacity-20" />
                  </div>
                )}
              </div>
                ...
                <div className="mt-5 flex gap-2 border-t border-border pt-4">
                  {p.liveUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-full bg-foreground px-3 py-2 text-xs font-semibold text-background hover:opacity-90"
                    >
                  ...
                  {p.githubUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-full border border-border px-3 py-2 text-xs font-semibold hover:bg-muted"
                    >
