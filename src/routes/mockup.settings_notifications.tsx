...
function SettingsNotificationsPage() {
  return (
    <>
      <nav className="hidden md:flex flex-col h-full py-lg px-md w-sidebar-width overflow-y-auto bg-surface-container-lowest shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] z-50 fixed left-0 top-0">
        <div className="flex items-center gap-sm mb-xl px-sm">
          ...
          <span className="font-label-sm text-label-sm text-on-surface-variant bg-surface-container py-xs px-sm rounded-full">
            Career OS
          </span>
        </div>
        <button className="w-full bg-primary text-on-primary py-sm px-md rounded-lg font-headline-md text-body-md hover:bg-primary-container transition-colors duration-200 mb-lg flex items-center justify-center gap-sm shadow-sm active:scale-[0.98]">
        ...
        <div className="flex-1 flex flex-col gap-xs">
          <a
            className="flex items-center gap-md py-sm px-md rounded-lg text-on-surface-variant hover:bg-surface-container transition-colors duration-200 active:scale-[0.98]"
            href="#"
          >
        ...
        <div className="mt-auto pt-lg border-t border-outline-variant/30 flex flex-col gap-xs">
          <a
            className="flex items-center gap-md py-sm px-md rounded-lg text-primary font-bold border-r-4 border-primary bg-surface-container-low transition-colors duration-200 active:scale-[0.98]"
            href="#"
          >
            <span
      ...
      <main className="flex-1 md:ml-sidebar-width flex flex-col min-h-screen relative">
        <header className="hidden md:flex justify-between items-center px-xl w-[calc(100%-280px)] h-16 z-40 fixed top-0 right-0 bg-surface/80 backdrop-blur-md">
          ...
          <div className="flex items-center gap-sm">
            ...
            <div className="ml-sm w-8 h-8 rounded-full bg-primary-container text-on-primary-container flex items-center justify-center font-headline-md text-[14px] cursor-pointer shadow-sm">
              AC
            </div>
          </div>
        </header>

        <div className="flex-1 p-md md:p-xl mt-0 md:mt-16 w-full max-w-container-max mx-auto">
          <div className="mb-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-lg">
            ...
            <div className="space-y-lg">
              <div className="bg-surface-container-low rounded-xl p-lg border border-outline-variant/30">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-md">
          ...
          <div className="mt-xl flex justify-end gap-md">
            <button className="px-lg py-2 rounded-lg font-body-md text-body-md text-on-surface-variant hover:bg-surface-container transition-colors">
              Cancel
            </button>
            <button className="px-lg py-2 rounded-lg font-body-md text-body-md bg-primary text-on-primary hover:bg-primary-container transition-colors shadow-sm">
              Save Changes
            </button>
          </div>
        </div>
