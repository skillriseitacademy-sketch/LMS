...
export const Route = createFileRoute("/mockup/admin_dashboard_job_placement_analytics")({
  component: AdminDashboardJobPlacementAnalyticsPage,
});

function AdminDashboardJobPlacementAnalyticsPage() {
  return (
    <>
        ...
        <div className="p-xl max-w-container-max mx-auto w-full flex flex-col gap-xl">
          ...
          <section className="flex flex-col gap-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-lg">
              <div className="bg-surface-container-lowest rounded-xl p-lg shadow-card border-l-4 border-primary flex flex-col gap-sm">
                <p className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">
                  Average Rating
                </p>
                <div className="flex items-baseline gap-sm">
                  <h4 className="text-headline-lg font-headline-lg text-on-surface">4.8/5</h4>
                  <span className="text-primary text-sm font-medium flex items-center gap-xs">
                    <span className="material-symbols-outlined text-[16px]">trending_up</span>
                    +0.2
                  </span>
                </div>
                <p className="text-label-sm text-on-surface-variant">vs last month</p>
              </div>

              <div className="bg-surface-container-lowest rounded-xl p-lg shadow-card border-l-4 border-secondary-container flex flex-col gap-sm">
                <p className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">
                  Course Completion
                </p>
                <h4 className="text-headline-lg font-headline-lg text-on-surface">84%</h4>
                <div className="w-full bg-surface-variant h-1.5 rounded-full mt-xs overflow-hidden">
                  <div
              ...
              <div className="bg-surface-container-lowest rounded-xl p-lg shadow-card border-l-4 border-tertiary flex flex-col gap-sm">
                <p className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">
                  Active Teachers
                </p>
                <div className="flex items-center justify-between">
                  <h4 className="text-headline-lg font-headline-lg text-on-surface">142</h4>
                  <span className="px-sm py-xs bg-tertiary-container text-on-error-container rounded-full text-[10px] font-bold">
                    +12 NEW
                  </span>
                </div>
            ...
            <div className="bg-surface-container-lowest rounded-xl shadow-card overflow-hidden border border-outline-variant/30">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-surface-container-low border-b border-outline-variant">
                      <th className="p-md font-label-sm text-label-sm text-on-surface-variant uppercase">
                        Teacher
                      </th>
                      <th className="p-md font-label-sm text-label-sm text-on-surface-variant uppercase">
                        Rating
                  ...
                  <tbody className="divide-y divide-outline-variant/30">
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-md font-medium text-on-surface">Dr. Aris V.</td>
                      <td className="p-md text-on-surface-variant">4.9</td>
                      <td className="p-md text-on-surface-variant">1.2k</td>
                      <td className="p-md text-on-surface-variant">92%</td>
                    </tr>
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-md font-medium text-on-surface">Sarah Jenkins</td>
                      <td className="p-md text-on-surface-variant">4.8</td>
                      <td className="p-md text-on-surface-variant">850</td>
                      <td className="p-md text-on-surface-variant">88%</td>
                    </tr>
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-md font-medium text-on-surface">Prof. Kumar</td>
                      <td className="p-md text-on-surface-variant">4.7</td>
                      <td className="p-md text-on-surface-variant">2.1k</td>
                      <td className="p-md text-on-surface-variant">81%</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <section className="flex flex-col gap-lg mt-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-lg">
              <div className="bg-surface-container-lowest rounded-xl p-lg shadow-card border-l-4 border-primary flex flex-col gap-sm">
                ...
                <div className="flex items-baseline gap-sm">
                  <h4 className="text-headline-lg font-headline-lg text-on-surface">72%</h4>
                  <span className="text-primary text-sm font-medium flex items-center gap-xs">
                    <span className="material-symbols-outlined text-[16px]">trending_up</span>
                    +5%
                  </span>
                </div>
                <p className="text-label-sm text-on-surface-variant">vs last cohort</p>
              </div>
              ...
              <div className="bg-surface-container-lowest rounded-xl p-lg shadow-card border-l-4 border-secondary-container flex flex-col gap-sm">
                ...
                <h4 className="text-headline-lg font-headline-lg text-on-surface">₹12.4 LPA</h4>
                <p className="text-label-sm text-on-surface-variant">Highest: ₹45 LPA</p>
              </div>
              ...
              <div className="bg-surface-container-lowest rounded-xl p-lg shadow-card border-l-4 border-tertiary flex flex-col gap-sm">
                ...
                <p className="text-label-sm text-on-surface-variant">24 hires this cohort</p>
              </div>
            </div>

            <div className="bg-surface-container-lowest rounded-xl shadow-card overflow-hidden border border-outline-variant/30">
              <div className="p-md border-b border-outline-variant bg-surface-container-low">
                <h4 className="font-semibold text-on-surface">Top Hiring Partners</h4>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                  ...
                  <tbody className="divide-y divide-outline-variant/30">
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-md font-medium text-on-surface">TechNova Solutions</td>
                      <td className="p-md text-on-surface-variant">24</td>
                      <td className="p-md text-on-surface-variant">₹15 LPA</td>
                      <td className="p-md text-on-surface-variant">4.8</td>
                    </tr>
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-md font-medium text-on-surface">CloudScale Inc</td>
                      <td className="p-md text-on-surface-variant">18</td>
                      <td className="p-md text-on-surface-variant">₹12 LPA</td>
                      <td className="p-md text-on-surface-variant">4.5</td>
                    </tr>
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-md font-medium text-on-surface">FinEdge Systems</td>
                      <td className="p-md text-on-surface-variant">12</td>
                      <td className="p-md text-on-surface-variant">₹18 LPA</td>
                      <td className="p-md text-on-surface-variant">4.9</td>
                    </tr>
                  </tbody>
                </table>
