        ...
        <div className="p-8 max-w-container-max mx-auto w-full flex flex-col gap-8">
          ...
          <section className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-surface-container-lowest rounded-xl p-6 shadow-card border-l-4 border-primary flex flex-col gap-2">
                <p className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">
                  Average Rating
                </p>
              ...
              <div className="bg-surface-container-lowest rounded-xl p-6 shadow-card border-l-4 border-secondary-container flex flex-col gap-2">
                <p className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">
                  Course Completion
                </p>
              ...
              <div className="bg-surface-container-lowest rounded-xl p-6 shadow-card border-l-4 border-tertiary flex flex-col gap-2">
                <p className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">
                  Active Teachers
                </p>
                <div className="flex items-center justify-between">
                  <h4 className="text-headline-lg font-headline-lg text-on-surface">142</h4>
                  <span className="px-2 py-1 bg-tertiary-container text-on-error-container rounded-full text-[10px] font-bold">
                    +12 NEW
                  </span>
                </div>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-outline-variant/30">
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-4 font-medium text-on-surface">Dr. Aris V.</td>
                      <td className="p-4 text-on-surface-variant">4.9</td>
                      <td className="p-4 text-on-surface-variant">1.2k</td>
                      <td className="p-4 text-on-surface-variant">92%</td>
                    </tr>
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-4 font-medium text-on-surface">Sarah Jenkins</td>
                      <td className="p-4 text-on-surface-variant">4.8</td>
                      <td className="p-4 text-on-surface-variant">850</td>
                      <td className="p-4 text-on-surface-variant">88%</td>
                    </tr>
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-4 font-medium text-on-surface">Prof. Kumar</td>
                      <td className="p-4 text-on-surface-variant">4.7</td>
                      <td className="p-4 text-on-surface-variant">2.1k</td>
                      <td className="p-4 text-on-surface-variant">81%</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-surface-container-lowest rounded-xl shadow-card overflow-hidden border border-outline-variant/30">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-outline-variant/30">
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-4 font-medium text-on-surface">TechNova Solutions</td>
                      <td className="p-4 text-on-surface-variant">24</td>
                      <td className="p-4 text-on-surface-variant">₹15 LPA</td>
                      <td className="p-4 text-on-surface-variant">4.8</td>
                    </tr>
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-4 font-medium text-on-surface">CloudScale Inc</td>
                      <td className="p-4 text-on-surface-variant">18</td>
                      <td className="p-4 text-on-surface-variant">₹12 LPA</td>
                      <td className="p-4 text-on-surface-variant">4.5</td>
                    </tr>
                    <tr className="hover:bg-surface-container-low transition-colors">
                      <td className="p-4 font-medium text-on-surface">FinEdge Systems</td>
                      <td className="p-4 text-on-surface-variant">12</td>
                      <td className="p-4 text-on-surface-variant">₹18 LPA</td>
                      <td className="p-4 text-on-surface-variant">4.9</td>
                    </tr>
                  </tbody>
                </table>
