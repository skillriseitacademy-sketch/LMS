    ...
    <>
      ...
      <main className="md:ml-[280px] w-full min-h-screen pt-16 md:pt-24 pb-24 md:pb-xl px-4 md:px-xl max-w-[1560px] mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-[380px] flex flex-col gap-6 shrink-0">
          <div className="bg-surface-container-lowest rounded-xl p-6 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] border-t-4 border-primary animate-success-card">
            <h3
              className="font-headline-md text-[20px] font-semibold text-on-surface mb-2 relative inline-block"
              id="success-heading"
            >
              Application Sent! 🎉
            </h3>
