...
export const Route = createFileRoute("/mockup/jobs_board_role_details_animated_success")({
  component: JobsBoardRoleDetailsAnimatedSuccessPage,
});

function JobsBoardRoleDetailsAnimatedSuccessPage() {
  return (
    <>
      ...
      <main className="md:ml-[280px] w-full min-h-screen pt-16 md:pt-24 pb-24 md:pb-xl px-4 md:px-xl max-w-[1560px] mx-auto flex flex-col md:flex-row gap-xl">
        ...
        <div className="w-full md:w-[380px] flex flex-col gap-lg shrink-0">
          <div className="bg-surface-container-lowest rounded-xl p-lg shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] border-t-4 border-primary animate-success-card">
            <h3
              className="font-headline-md text-[20px] font-semibold text-on-surface mb-sm relative inline-block"
              id="success-heading"
            >
              Application Sent! 🎉
            </h3>
            ...
            <button className="w-full text-on-primary font-body-md text-body-md font-semibold py-3 rounded-lg hover:bg-primary/90 transition-all duration-200 active:scale-[0.98] shadow-sm flex items-center justify-center gap-2 group bg-secondary animate-btn-pulse">
