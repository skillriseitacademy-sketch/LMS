  ...
  head: () => ({
    meta: [
      { title: "PlacePro — The new standard in placement prep" },
      {
        name: "description",
        content:
          "Get placement-ready – interviews, quizzes, live classes, and a community that's doing it with you.",
      },
    ],
  }),
  component: Landing,
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-[#3424C2]/20 selection:text-[#3424C2]">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-white/80 backdrop-blur-md border-b border-slate-100">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/signup"
            className="rounded-full bg-[#3424C2] px-5 py-2 text-sm font-bold text-white transition-all hover:bg-[#2A1D9C] shadow-sm"
          >
            Get Started
          </Link>
        </div>
      ...
      <section className="pt-32 pb-20 px-4 text-center bg-gradient-to-b from-[#F4F4FF] to-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight mb-6">
            ...
            quizzes, live classes, and a{" "}
            <span className="relative whitespace-nowrap">
              <span className="relative z-10 text-[#3424C2]">community</span>
              <svg
                className="absolute w-full h-3 -bottom-1 left-0 text-orange-400"
                viewBox="0 0 100 10"
          ...
          <p className="text-lg md:text-xl text-slate-500 mb-10 max-w-2xl mx-auto">
            Stop stressing about placements. PlacePro provides a structured, gamified environment to
            master skills, practice in real-time, and land your dream role.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/signup"
              className="w-full sm:w-auto rounded-full bg-[#3424C2] px-8 py-4 text-[15px] font-bold text-white transition-transform hover:scale-105 shadow-[0_4px_20px_rgba(52,36,194,0.25)] flex items-center justify-center gap-2"
            >
              Get Started <ArrowRight className="h-4 w-4" />
            </Link>
            <Link
              to="/login"
              className="w-full sm:w-auto rounded-full bg-white border border-slate-200 px-8 py-4 text-[15px] font-bold text-slate-700 transition-all hover:bg-slate-50 hover:border-slate-300 flex items-center justify-center shadow-sm"
            >
              Log in
            </Link>
          </div>
          ...
          <div className="rounded-xl overflow-hidden shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-slate-200/50 relative bg-white aspect-[16/9] flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-slate-50 flex flex-col">
              <div className="h-10 bg-slate-100 border-b flex items-center px-4 gap-2">
                ...
                <div className="ml-4 h-5 w-48 bg-white rounded shadow-sm border border-slate-200 text-center text-[10px] text-slate-400 flex items-center justify-center">
                  placepro.app/dashboard
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <p className="text-slate-500 relative z-10 mb-8">
                We analyze your current skill level and generate a custom, week-by-week study plan
                to ensure you're ready for placement season.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-12 relative z-10">
              <div className="text-center">
                <div className="mx-auto w-20 h-20 bg-white rounded-full border-2 border-slate-100 flex items-center justify-center shadow-sm relative mb-6">
                  <div className="absolute -top-3 -right-3 h-8 w-8 bg-[#3424C2] text-white rounded-full font-bold flex items-center justify-center border-[3px] border-white">
                    1
                  </div>
              ...
              <div className="text-center">
                ...
                <p className="text-slate-500 text-sm leading-relaxed">
                  Enter the Arena for timed coding bouts, schedule mock interviews, and build muscle
                  memory for the real thing.
                </p>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm relative">
              ...
              <p className="text-slate-600 italic text-sm leading-relaxed">
                "The AI mock interviews were a game-changer. They highlighted flaws in my delivery I
                never knew I had. By the time the real interview came, I felt like I was just
                talking to a friend."
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm relative">
              ...
              <p className="text-slate-600 italic text-sm leading-relaxed">
                "I loved the live classes. The instructors didn't just teach theory; they focused on
                what interviewers actually look for. The community aspect kept me motivated during
                the tough weeks."
              </p>
            </div>
          </div>
      ...
      <section className="py-24 bg-[#3424C2] px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <Link
            to="/signup"
            className="inline-block rounded-full bg-white px-8 py-4 text-base font-bold text-[#3424C2] transition-transform hover:scale-105 shadow-lg"
          >
