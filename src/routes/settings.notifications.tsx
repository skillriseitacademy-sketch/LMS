...
const SECTIONS: { title: string; icon: string; color: string; items: Toggle[] }[] = [
  {
    ...
    items: [
      {
        id: "interview_invites",
        label: "Interview Invitations",
        desc: "Get instantly notified when a company invites you to interview.",
        defaultOn: true,
      },
      {
        id: "job_matches",
        label: "New Job Matches",
        desc: "Alerts for new postings that align with your profile and skills.",
        defaultOn: true,
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "arena_challenges",
        label: "Coding Arena Challenges",
        desc: "Notifications for upcoming tournaments and daily challenges.",
        defaultOn: false,
      },
      {
        id: "quiz_reminders",
        label: "Quiz Reminders",
        desc: "Scheduled nudges to complete your daily aptitude quizzes.",
        defaultOn: true,
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "feed_activity",
        label: "Social Feed Activity",
        desc: "Mentions, likes, and comments on your feed posts.",
        defaultOn: false,
      },
      {
        id: "connection_requests",
        label: "Connection Requests",
        desc: "When someone sends you a connection request.",
        defaultOn: true,
      },
    ],
  },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-1">
          <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm border border-primary/20 sticky top-6">
            ...
            <h3 className="font-semibold text-on-surface mb-2" style={{ fontFamily: "Manrope" }}>
              Email Delivery
            </h3>
            <p
              ...
              style={{ fontFamily: "Inter" }}
            >
              Crucial updates like interview invites will always be sent to your registered email
              address, regardless of push notification settings.
            </p>
            <button
      ...
      <div className="flex items-center justify-end gap-4 pt-2">
        {saved && (
          <span className="text-sm text-primary font-medium" style={{ fontFamily: "Inter" }}>
            ✓ Saved
          </span>
        )}
        <button
