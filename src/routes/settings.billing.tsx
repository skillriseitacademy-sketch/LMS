...
function BillingPage() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-semibold text-on-surface" style={{ fontFamily: "Manrope" }}>
          Plan & Billing
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="md:col-span-2 bg-surface-container-lowest rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="px-2 py-0.5 text-[10px] font-bold rounded-full bg-surface-variant text-on-surface-variant border border-outline-variant uppercase">
              Free Tier
            </span>
          </div>
          <h3
            className="text-2xl font-bold text-on-surface mt-2 mb-2"
            style={{ fontFamily: "Manrope" }}
          >
            PlacePro Basic
          </h3>
          <p className="text-sm text-on-surface-variant mb-4" style={{ fontFamily: "Inter" }}>
            You are currently on the free tier. Upgrade to Pro to unlock advanced career preparation
            tools.
          </p>
          <div className="flex items-center justify-between pt-4 border-t border-outline-variant/40">
            <span className="text-sm text-on-surface-variant" style={{ fontFamily: "Inter" }}>
              Free forever · Basic access to feed and roadmap.
            </span>
            <Link
              to="/pro"
        ...
        <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm flex flex-col">
          <p
            className="text-xs font-semibold text-on-surface-variant uppercase tracking-widest mb-3"
            style={{ fontFamily: "JetBrains Mono" }}
          >
            Payment Method
          </p>
          ...
          <button
            className="mt-auto w-full py-2.5 text-primary border border-primary/40 rounded-xl text-sm font-medium hover:bg-primary hover:text-on-primary transition-all"
            style={{ fontFamily: "Inter" }}
          >
            Add Payment Method
          </button>
      ...
      <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm">
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-lg font-semibold text-on-surface" style={{ fontFamily: "Manrope" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {PRO_FEATURES.map(({ icon, color, title, desc }) => (
            <div
              key={title}
              className="p-5 rounded-2xl border border-outline-variant/40 hover:border-primary/30 transition-all"
            >
              <div
              ...
              <h4
                className="font-semibold text-on-surface mb-2 text-sm"
                style={{ fontFamily: "Manrope" }}
              >
                {title}
              </h4>
