    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-on-surface-variant mt-1" style={{ fontFamily: "Inter" }}>
          Manage your account security, authentication methods, and review active sessions to keep
          your Career OS data safe.
        </p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h3 className="font-semibold text-on-surface" style={{ fontFamily: "Manrope" }}>
                  Password
                </h3>
          ...
          <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              ...
              <div
                className={`w-6 h-6 rounded-full flex items-center justify-center ${twoFAEnabled ? "bg-primary" : "bg-surface-variant"}`}
              >
                {twoFAEnabled && (
          ...
          <div className="bg-error/5 border border-error/20 rounded-2xl p-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-error" style={{ fontFamily: "Manrope" }}>
                Danger Zone
              </h3>
            </div>
                ...
                <div key={sess.id} className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {sess.isCurrent && (
                        <span className="px-1.5 py-0.5 text-[9px] font-bold bg-primary/10 text-primary rounded uppercase tracking-wider">
                          Current
                        </span>
                      )}
                    </div>
