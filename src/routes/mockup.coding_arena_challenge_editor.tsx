...
function CodingArenaChallengeEditorPage() {
  return (
    <>
      <header className="h-16 bg-surface-container-lowest border-b border-outline-variant flex items-center justify-between px-6 flex-shrink-0 z-10 shadow-sm">
      ...
      <main className="flex-1 split-pane bg-surface">
        <section
          className="pane w-1/3 min-w-[300px] bg-surface-container-lowest p-6 border-r border-outline-variant flex flex-col gap-6"
          id="left-pane"
        >
          ...
          <div className="prose prose-sm text-on-surface-variant flex-1">
            ...
            <h3 className="font-headline-md text-headline-md mt-4 text-on-surface">
              Constraints:
            </h3>
            ...
            <h3 className="font-headline-md text-headline-md mt-4 text-on-surface">Example 1:</h3>
            <div className="bg-surface-container p-4 rounded-lg font-label-sm text-label-sm code-font">
          ...
          <div className="mt-auto pt-4 border-t border-outline-variant">
            <details className="group">
              <summary className="flex items-center cursor-pointer font-label-sm text-label-sm text-primary hover:text-primary-container transition-colors">
                <span className="material-symbols-outlined mr-2 transition-transform group-open:rotate-90">
                  chevron_right
                </span>
                Show Hint 1
              </summary>
              <div className="mt-2 p-2 bg-surface-container-low rounded border border-outline-variant text-sm text-on-surface-variant">
        ...
        <section
          ...
          id="right-pane"
        >
          <div className="h-12 bg-on-background flex items-center justify-between px-4 border-b border-outline">
            <div className="flex items-center gap-2">
          ...
          <div className="flex-1 relative overflow-auto p-4 font-label-sm text-label-sm code-font leading-relaxed">
            <div className="absolute left-0 top-0 bottom-0 w-10 bg-on-background border-r border-outline text-outline text-right pr-2 pt-4 select-none">
          ...
          <div className="border-t border-outline bg-on-background flex flex-col">
            <div className="p-2 flex justify-between items-center border-b border-outline">
              <button className="flex items-center gap-1 px-3 py-1.5 text-on-tertiary hover:bg-surface-variant hover:text-on-surface-variant rounded transition-colors font-label-sm text-label-sm">
                <span className="material-symbols-outlined text-sm">terminal</span>
                Console
              </button>
              <div className="flex gap-4">
                <button className="px-4 py-2 bg-surface-container-low text-on-surface rounded font-label-sm text-label-sm font-bold hover:bg-surface-variant transition-colors flex items-center gap-1">
                  <span className="material-symbols-outlined text-sm">play_arrow</span>
                  Run Code
                </button>
                <button className="px-4 py-2 bg-primary text-on-primary rounded font-label-sm text-label-sm font-bold hover:bg-primary-container hover:scale-105 transition-all shadow-md flex items-center gap-1">
            ...
            <div className="h-32 bg-inverse-surface p-2 overflow-y-auto hidden">
