  ...
  return (
    <>
      <div className="w-full max-w-[800px] flex flex-col gap-8">
        ...
        <div
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-lg"
          id="topics-grid"
        >
          <button
            aria-pressed="true"
            className="topic-card group relative bg-surface-container-lowest rounded-2xl p-6 shadow-card border-2 border-primary text-left transition-all hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
          ...
          >
            ...
            <div className="w-12 h-12 rounded-xl bg-primary-container text-primary flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <span
            ...
            <h3 className="font-headline-md text-body-lg font-bold text-on-surface mb-1">
              Data Structures
            </h3>
          ...
          <button
            aria-pressed="false"
            className="topic-card group relative bg-surface-container-lowest rounded-2xl p-6 shadow-card border-2 border-transparent hover:border-outline-variant text-left transition-all hover:shadow-card-hover hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
            onclick="toggleCard(this)"
          >
            <div className="absolute top-sm right-sm text-outline opacity-0 group-hover:opacity-50 transition-opacity">
              <span className="material-symbols-outlined">add_circle</span>
            </div>
            <div className="w-12 h-12 rounded-xl bg-surface-container-high text-on-surface-variant flex items-center justify-center mb-4 group-hover:bg-primary-fixed-dim transition-colors group-hover:text-primary">
        ...
        <div className="flex items-center justify-between mt-8 pt-6 border-t border-outline-variant">
          <button className="px-6 py-4 rounded-lg font-label-sm text-label-sm text-on-surface-variant hover:bg-surface-variant transition-colors">
            Skip for now
          </button>
          <button className="px-8 py-4 rounded-lg font-label-sm text-label-sm bg-primary text-on-primary font-bold shadow-md hover:bg-primary-fixed-variant hover:scale-105 transition-all flex items-center gap-2">
            Next Step
