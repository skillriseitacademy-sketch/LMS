...
function PlaceproProPremiumFeaturesHubPage() {
  return (
    <>
      <header className="bg-surface docked full-width top-0 sticky z-50 border-b border-outline-variant shadow-sm flex justify-between items-center px-lg py-md max-w-container-max mx-auto">
        ...
        <div className="flex items-center gap-md">
          ...
          <button className="bg-primary text-on-primary px-lg py-sm rounded-lg font-medium hover:bg-primary-container hover:scale-95 transition-all duration-200">
            Get Started
          </button>
        </div>
      </header>
      <main className="max-w-container-max mx-auto px-lg py-xl flex flex-col gap-xl">
        <section className="relative rounded-xl bg-surface-container-lowest shadow-sm border border-outline-variant overflow-hidden p-xl md:p-2xl flex flex-col md:flex-row items-center gap-xl text-center md:text-left">
          <div className="absolute inset-0 bg-gradient-to-br from-surface-container-high/50 to-transparent pointer-events-none"></div>
          <div className="flex-1 z-10 flex flex-col items-center md:items-start gap-md">
            <div className="inline-flex items-center gap-sm bg-secondary-container/20 text-secondary border border-secondary/30 px-md py-xs rounded-full font-label-sm text-label-sm mb-sm">
              <span
            ...
            <div className="flex gap-md mt-lg">
              <button className="bg-secondary-container text-on-secondary-container px-xl py-md rounded-lg font-medium hover:brightness-110 hover:scale-105 transition-all duration-200 shadow-md">
                Upgrade to Pro Now
              </button>
              <button className="bg-surface text-on-surface border border-outline-variant px-xl py-md rounded-lg font-medium hover:bg-surface-variant transition-colors duration-200 shadow-sm">
                View Pricing
              </button>
            </div>
          </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-md">
          <div className="col-span-1 md:col-span-2 bg-surface-container-lowest rounded-xl shadow-sm border-l-4 border-l-primary p-lg flex flex-col gap-md relative overflow-hidden group">
            ...
            <div className="mt-auto pt-md flex items-center gap-sm font-label-sm text-label-sm text-primary">
              <span className="material-symbols-outlined text-sm">check_circle</span> 95%+ ATS Score
              Guarantee
            </div>
          </div>
          <div className="col-span-1 bg-surface-container-lowest rounded-xl shadow-sm border-l-4 border-l-secondary-container p-lg flex flex-col gap-md">
            <div className="flex items-center gap-md">
          ...
          <div className="col-span-1 bg-surface-container-lowest rounded-xl shadow-sm border-l-4 border-l-primary p-lg flex flex-col gap-md">
            <div className="flex items-center gap-md">
              <div className="w-12 h-12 rounded-full bg-primary-container/20 flex items-center justify-center text-primary">
                <span
                  className="material-symbols-outlined"
          ...
          <div className="col-span-1 md:col-span-2 bg-surface-container-lowest rounded-xl shadow-sm border-l-4 border-l-secondary-container p-lg flex flex-col md:flex-row gap-lg items-center relative overflow-hidden">
            <div className="flex-1 flex flex-col gap-md">
              <div className="inline-flex items-center gap-sm bg-surface-container-high text-on-surface-variant px-sm py-xs rounded font-label-sm text-label-sm w-max">
                New Feature
              </div>
      ...
      <footer className="bg-surface-container-highest w-full py-xl border-t border-outline-variant mt-xl">
