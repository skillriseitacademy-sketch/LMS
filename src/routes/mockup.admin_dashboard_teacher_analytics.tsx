...
export const Route = createFileRoute("/mockup/admin_dashboard_teacher_analytics")({
  component: AdminDashboardTeacherAnalyticsPage,
});

function AdminDashboardTeacherAnalyticsPage() {
  return (
    <>
