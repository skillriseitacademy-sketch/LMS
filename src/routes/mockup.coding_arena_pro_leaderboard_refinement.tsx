...
export const Route = createFileRoute("/mockup/coding_arena_pro_leaderboard_refinement")({
  component: CodingArenaProLeaderboardRefinementPage,
});

function CodingArenaProLeaderboardRefinementPage() {
  return (
    <>
