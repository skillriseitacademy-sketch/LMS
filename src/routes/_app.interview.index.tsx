  ...
  return (
    <div className="pt-8 px-4 md:px-8 pb-8 max-w-container-max mx-auto w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
        ...
        <button
          className="bg-primary hover:bg-primary/90 text-on-primary rounded-xl py-3 px-6 text-base leading-[1.5] font-semibold transition-transform duration-150 active:scale-[0.98] shadow-sm flex items-center justify-center gap-2 whitespace-nowrap w-full md:w-auto"
          style={{ fontFamily: "Inter" }}
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-surface-container-lowest rounded-[16px] p-6 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] border border-outline-variant/30 hover:border-primary/50 transition-all duration-300 group cursor-pointer relative overflow-hidden">
              ...
              <p
                className="text-base leading-[1.5] text-on-surface-variant mb-6 relative z-10"
                style={{ fontFamily: "Inter" }}
              >
                STAR method drills, leadership principles, and culture fit simulations.
              </p>
              <div
                className="flex items-center text-primary font-semibold text-base leading-[1.5] relative z-10 group-hover:translate-x-1 transition-transform"
                style={{ fontFamily: "Inter" }}
              >
                Select Mode{" "}
            ...
            <div className="bg-surface-container-lowest rounded-[16px] p-6 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] border border-outline-variant/30 hover:border-primary/50 transition-all duration-300 group cursor-pointer relative overflow-hidden">
              ...
              <div
                className="flex items-center text-secondary font-semibold text-base leading-[1.5] relative z-10 group-hover:translate-x-1 transition-transform"
                style={{ fontFamily: "Inter" }}
              >
                Select Mode{" "}
                <span className="material-symbols-outlined ml-1 text-[20px]">arrow_forward</span>
            ...
            <div className="bg-surface-container-lowest rounded-[16px] p-6 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] border border-outline-variant/30 hover:border-primary/50 transition-all duration-300 group cursor-pointer relative overflow-hidden">
              ...
              <div
                className="flex items-center text-tertiary font-semibold text-base leading-[1.5] relative z-10 group-hover:translate-x-1 transition-transform"
                style={{ fontFamily: "Inter" }}
              >
                Select Mode{" "}
                <span className="material-symbols-outlined ml-1 text-[20px]">arrow_forward</span>
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            <button
              className="text-primary text-base leading-[1.5] font-medium hover:underline"
              style={{ fontFamily: "Inter" }}
            >
              View Calendar
            </button>
          ...
          <div className="bg-surface-container-lowest rounded-[16px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] border border-outline-variant/30 overflow-hidden flex flex-col">
            ...
            <div className="p-6 border-b border-surface-variant hover:bg-surface-container-low/50 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-l-4 border-l-primary">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-primary-fixed text-on-primary-fixed flex flex-col items-center justify-center shrink-0">
                  <span
                    className="text-xs tracking-[0.05em] font-bold uppercase"
                    style={{ fontFamily: "JetBrains Mono" }}
                  >
                    Oct
                  </span>
                  <span
                    className="text-[24px] font-semibold leading-[1.3] leading-none font-bold"
                    style={{ fontFamily: "Manrope" }}
                  >
                    24
                  </span>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span
                      className="px-2 py-0.5 rounded-full bg-primary-container/10 text-primary text-xs tracking-[0.05em] font-medium"
                      style={{ fontFamily: "JetBrains Mono" }}
                    >
                      AI Session
                    </span>
                  ...
                  <p
                    className="text-base leading-[1.5] text-on-surface-variant flex items-center gap-1"
                    style={{ fontFamily: "Inter" }}
                  >
              ...
              <button
                className="bg-primary text-on-primary rounded-lg py-2 px-6 text-base leading-[1.5] font-medium transition-transform active:scale-[0.98] shrink-0 self-start sm:self-center"
                style={{ fontFamily: "Inter" }}
              >
                Join Now
              </button>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span
                      className="px-2 py-0.5 rounded-full bg-secondary-container/10 text-secondary-container text-xs tracking-[0.05em] font-medium"
                      style={{ fontFamily: "JetBrains Mono" }}
                    >
                      Peer Session
                    </span>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Inter" }}
                  >
                    <span className="material-symbols-outlined text-[16px]">person</span> Alex Chen
                    (Confirmed)
                  </p>
                </div>
              </div>
              <button
                className="bg-surface-variant text-on-surface-variant rounded-lg py-2 px-6 text-base leading-[1.5] font-medium cursor-not-allowed shrink-0 self-start sm:self-center"
                style={{ fontFamily: "Inter" }}
                disabled
              >
                Starts in 2d
            ...
            <div className="p-4 text-center">
              <button
                className="text-on-surface-variant text-base leading-[1.5] font-medium hover:text-primary transition-colors"
                style={{ fontFamily: "Inter" }}
              >
                Load More
              </button>
          ...
          <div className="bg-surface-container-lowest rounded-[16px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] border border-outline-variant/30 p-6 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-xl hover:bg-surface-container-low transition-colors group cursor-pointer border border-transparent hover:border-outline-variant/30">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4
                    className="text-base leading-[1.5] font-semibold text-on-surface group-hover:text-primary transition-colors"
                    style={{ fontFamily: "Inter" }}
                  >
                    Arrays & Strings
                  </h4>
              ...
              <div className="flex flex-col items-end">
                <span
                  className="text-[18px] font-semibold leading-[1.3] text-primary"
                  style={{ fontFamily: "Manrope" }}
                >
                  85/100
                </span>
                <span
                  className="text-xs tracking-[0.05em] font-medium text-primary flex items-center"
                  style={{ fontFamily: "JetBrains Mono" }}
                >
                  <span className="material-symbols-outlined text-[12px]">arrow_upward</span> Strong
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-xl hover:bg-surface-container-low transition-colors group cursor-pointer border border-transparent hover:border-outline-variant/30">
              ...
              <div className="flex flex-col items-end">
                <span
                  className="text-[18px] font-semibold leading-[1.3] text-secondary-container"
                  style={{ fontFamily: "Manrope" }}
                >
                  68/100
                </span>
                <span
                  className="text-xs tracking-[0.05em] font-medium text-secondary-container flex items-center"
                  style={{ fontFamily: "JetBrains Mono" }}
                >
                  Needs Work
                </span>
            ...
            <button
              className="w-full mt-2 py-2 rounded-lg border border-outline-variant text-on-surface-variant text-base leading-[1.5] hover:bg-surface-container hover:text-on-surface transition-colors"
              style={{ fontFamily: "Inter" }}
            >
