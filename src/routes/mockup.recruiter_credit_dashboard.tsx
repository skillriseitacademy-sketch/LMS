...
function RecruiterCreditDashboardPage() {
  return (
    <>
      <nav className="hidden lg:flex flex-col h-screen sticky top-0 left-0 w-sidebar-width bg-surface-container-lowest shadow-md py-xl px-md space-y-md z-40">
        ...
        <div className="flex-1 flex flex-col gap-sm">
          <a
            className="flex items-center gap-md px-md py-sm rounded-lg text-on-surface-variant hover:bg-surface-container-low hover:text-primary transition-all duration-200"
            href="#"
          >
          ...
          <a
            className="flex items-center gap-md px-md py-sm rounded-lg text-primary font-bold border-r-4 border-primary bg-surface-container-low transition-all duration-200 hover:translate-x-1"
            href="#"
          >
            <span
        ...
        <div className="mt-auto flex flex-col gap-sm pt-md border-t border-outline-variant">
          <button className="w-full bg-secondary-container text-on-secondary-container font-label-sm text-label-sm py-sm rounded-lg flex items-center justify-center gap-sm hover:scale-105 transition-transform">
      ...
      <main className="flex-1 flex flex-col min-w-0 pb-[80px] lg:pb-0">
        <header className="flex justify-between items-center w-full px-lg py-sm max-w-container-max mx-auto bg-surface shadow-sm sticky top-0 z-30">
        ...
        <div className="p-md lg:p-xl max-w-container-max mx-auto w-full space-y-xl">
          <section className="grid grid-cols-1 md:grid-cols-3 gap-md">
            <div className="md:col-span-2 bg-white rounded-xl shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),_0_2px_4px_-2px_rgba(0,0,0,0.05)] p-lg flex flex-col justify-between border-l-4 border-primary">
              <div className="flex justify-between items-start mb-lg">
                ...
                <div className="bg-secondary-container/20 text-secondary-container px-sm py-xs rounded-full flex items-center gap-xs">
              ...
              <div className="mt-lg pt-md border-t border-outline-variant flex justify-between items-center">
                ...
                <button className="bg-primary text-on-primary px-lg py-sm rounded-lg font-label-sm text-label-sm hover:bg-primary-fixed-variant transition-colors flex items-center gap-sm shadow-sm">
                  <span className="material-symbols-outlined text-sm">search</span> Find Recruiters
                </button>
              </div>
            </div>
            <div className="bg-white rounded-xl shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),_0_2px_4px_-2px_rgba(0,0,0,0.05)] p-lg flex flex-col border-l-4 border-secondary-container">
              ...
              <button className="mt-md w-full border border-outline text-on-surface-variant px-sm py-sm rounded-lg font-label-sm text-label-sm hover:bg-surface-container transition-colors">
                Go to Arena
              </button>
            </div>
          </section>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-surface-container-low text-on-surface-variant font-label-sm text-label-sm border-b border-outline-variant">
                    <th className="p-md font-medium">Recruiter</th>
                    <th className="p-md font-medium">Company / Role</th>
                    <th className="p-md font-medium">Date Used</th>
                ...
                <tbody className="font-body-md text-body-md divide-y divide-outline-variant">
                  <tr className="hover:bg-surface-container transition-colors">
                    ...
                    <td className="p-md text-on-surface-variant font-label-sm text-label-sm">
                      Oct 18, 2023
                    </td>
                    <td className="p-md">
                      <span className="inline-flex items-center gap-xs bg-surface-variant text-primary px-sm py-xs rounded-full font-label-sm text-label-sm">
                  ...
                  <tr className="hover:bg-surface-container transition-colors">
                    ...
                    <td className="p-md">
                      <span className="inline-flex items-center gap-xs bg-surface-container-high text-on-surface-variant px-sm py-xs rounded-full font-label-sm text-label-sm">
                  ...
                  <tr className="hover:bg-surface-container transition-colors">
                    ...
                    <td className="p-md">
                      <span className="inline-flex items-center gap-xs border border-secondary text-secondary px-sm py-xs rounded-full font-label-sm text-label-sm">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-md py-sm pb-safe bg-surface shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] rounded-t-xl">
        <a
          className="flex flex-col items-center justify-center text-on-surface-variant hover:bg-surface-container-high p-sm rounded-lg transition-colors"
          href="#"
        >
          <span className="material-symbols-outlined mb-xs">home</span>
        ...
        <a
          ...
          href="#"
        >
          <span className="material-symbols-outlined mb-xs">quiz</span>
        ...
        <a
          ...
          href="#"
        >
          <span className="material-symbols-outlined mb-xs">workspace_premium</span>
