...
function SettingsSecurityPrivacyPage() {
  return (
    <>
      <aside className="fixed left-0 top-0 h-full w-sidebar-width bg-surface-container-lowest dark:bg-inverse-surface shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] z-50 flex flex-col py-lg px-md overflow-y-auto hidden md:flex">
        ...
        <button className="mb-lg w-full bg-primary text-on-primary py-sm px-md rounded-lg font-body-md hover:bg-primary-container hover:text-on-primary-container active:scale-[0.98] transition-all duration-150 flex items-center justify-center gap-sm">
        ...
        <nav className="flex-1 flex flex-col gap-xs">
          <a
            className="flex items-center gap-md px-md py-sm rounded-lg text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-inverse-primary hover:bg-surface-container dark:hover:bg-surface-variant transition-colors duration-200 group"
            href="#"
          >
          ...
          <a
            className="flex items-center gap-md px-md py-sm rounded-lg text-primary dark:text-inverse-primary font-bold border-r-4 border-primary dark:border-inverse-primary bg-surface-container-low dark:bg-surface-dim transition-colors duration-200 group"
            href="#"
          >
            <span
        ...
        <div className="mt-auto pt-lg border-t border-outline-variant/30 flex flex-col gap-xs">
          ...
          <a
            className="flex items-center gap-md px-md py-sm rounded-lg text-on-surface-variant dark:text-surface-variant hover:text-error dark:hover:text-error-container hover:bg-error-container/20 transition-colors duration-200 group"
            href="#"
          >
            <span className="material-symbols-outlined group-hover:scale-110 transition-transform">
              logout
          ...
          <div className="mt-md flex items-center gap-sm px-md">
            <img
      ...
      <header className="fixed top-0 right-0 w-full md:w-[calc(100%-280px)] h-16 bg-surface/80 dark:bg-background/80 backdrop-blur-md z-40 flex justify-between items-center px-xl md:px-xl transition-all duration-300">
        <div className="flex items-center gap-md">
          <button className="md:hidden text-on-surface p-sm hover:bg-surface-container rounded-lg">
          ...
          <div className="relative focus-within:ring-2 focus-within:ring-primary/20 rounded-lg transition-shadow duration-200 hidden md:block">
            ...
            <input
              className="pl-xl pr-md py-sm bg-surface-container-low border border-outline-variant/50 rounded-lg text-body-md focus:outline-none focus:border-primary/50 w-64 transition-colors"
        ...
        <div className="flex items-center gap-md">
          <button className="p-sm text-on-surface-variant hover:text-primary hover:bg-surface-container rounded-full transition-all relative group">
            <span className="material-symbols-outlined group-hover:scale-110 transition-transform">
              notifications
            </span>
            <span className="absolute top-1 right-1 w-2 h-2 bg-error rounded-full"></span>
          </button>
          <button className="p-sm text-secondary hover:text-secondary-container hover:bg-surface-container rounded-full transition-all group">
            <span className="material-symbols-outlined group-hover:scale-110 transition-transform">
              workspace_premium
            </span>
          </button>
      ...
      <main className="flex-1 ml-0 md:ml-sidebar-width pt-16 min-h-screen flex flex-col items-center">
        <div className="w-full max-w-container-max p-md md:p-xl flex flex-col gap-xl">
          <header className="flex flex-col gap-sm border-b border-outline-variant/30 pb-lg">
            <div className="flex items-center gap-sm text-outline font-label-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-lg lg:gap-xl">
            <div className="lg:col-span-2 flex flex-col gap-lg">
              <section className="glass-card rounded-xl p-lg md:p-xl flex flex-col gap-md">
                <div className="flex items-center gap-md border-b border-outline-variant/30 pb-md mb-sm">
                ...
                <form className="flex flex-col gap-md">
                  <div className="flex flex-col gap-xs">
                    ...
                    <input
                      className="px-md py-sm border border-outline-variant rounded-lg font-body-md focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all bg-surface"
                      id="current_password"
                      placeholder="••••••••"
                      type="password"
                    />
                  ...
                  <div className="flex items-center justify-between mt-sm">
                    ...
                    <button
                      className="bg-primary text-on-primary font-label-sm py-sm px-lg rounded-lg hover:bg-primary-container hover:shadow-md transition-all active:scale-95"
                      type="button"
                    >
                      Update Password
                    </button>
              ...
              <section className="glass-card rounded-xl p-lg md:p-xl flex flex-col gap-md">
                ...
                <div className="mt-md bg-surface-container-low rounded-lg p-md border-l-4 border-primary flex items-start gap-md">
            ...
            <div className="flex flex-col gap-lg">
              <section className="bg-surface-container-lowest rounded-xl border border-outline-variant/30 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-2px_rgba(0,0,0,0.05)] p-lg flex flex-col h-full">
                <div className="flex items-center justify-between border-b border-outline-variant/30 pb-md mb-md">
                  <h3 className="font-body-lg font-semibold text-on-surface flex items-center gap-sm">
                ...
                <div className="flex flex-col gap-md flex-1">
                  <div className="flex items-start gap-sm">
                    <div className="p-xs bg-surface-container rounded text-primary">
                      <span className="material-symbols-outlined text-[20px]">laptop_mac</span>
                    </div>
                    <div className="flex-1">
                      <p className="font-label-sm font-semibold text-on-surface flex items-center gap-xs">
                        MacBook Pro{" "}
                  ...
                  <div className="flex items-start gap-sm">
                    <div className="p-xs bg-surface-container rounded text-outline">
          ...
          <section className="mt-lg border border-error/30 rounded-xl p-lg bg-error-container/5 flex flex-col md:flex-row items-start md:items-center justify-between gap-md">
            <div>
              <h3 className="font-headline-md text-error flex items-center gap-sm">
                <span
                  className="material-symbols-outlined"
                  style={{ fontVariationSettings: "'FILL' 1" }}
                >
            ...
            <button className="bg-surface border border-error text-error font-label-sm py-sm px-lg rounded-lg hover:bg-error hover:text-on-error transition-colors active:scale-95 whitespace-nowrap">
              Delete Account
            </button>
          </section>
        </div>
