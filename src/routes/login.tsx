    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#EAE9FE] via-[#F2F1FF] to-[#E3E7FB] px-4 font-sans selection:bg-[#3424C2]/20">
      <div className="w-full max-w-[420px] rounded-[24px] bg-white p-8 md:p-10 shadow-[0_20px_40px_rgba(0,0,0,0.04)] border border-white">
        ...
        <div className="text-center mb-8">
          <h1 className="text-display text-[#3424C2] text-3xl font-bold tracking-tight">
            PlacePro
          </h1>
        ...
        {error && (
          <div
            className={`mb-5 rounded-[12px] p-3.5 text-sm ${error.includes("Check your email") ? "bg-emerald-50 text-emerald-700 border border-emerald-100" : "bg-red-50 text-red-700 border border-red-100"}`}
          >
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-[13px] font-semibold text-slate-700 mb-1.5 font-mono tracking-tight uppercase">
              Email
            </label>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block text-[13px] font-semibold text-slate-700 font-mono tracking-tight uppercase">
                Password
              </label>
              <button
                type="button"
