...
export function MinimalistTemplate({ data }: { data: ResumeData }) {
  return (
    <div
      className="bg-white text-black p-8 max-w-[800px] w-full min-h-[1056px] shadow-sm font-serif"
    ...
    >
      ...
      <div className="mb-6">
        <h2 className="text-xl font-bold uppercase tracking-widest border-b border-gray-400 mb-4 pb-1">
          Experience
        </h2>
