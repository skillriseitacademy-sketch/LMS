          ...
          <input
            ...
            onFocus={(e) => {
              ...
              (e.currentTarget as HTMLInputElement).style.boxShadow =
                "0 0 0 2px color-mix(in srgb, var(--pp-primary) 20%, transparent)";
            }}
            onBlur={(e) => {
              (e.currentTarget as HTMLInputElement).style.borderColor =
                "color-mix(in srgb, var(--pp-outline-variant) 50%, transparent)";
      ...
      >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.backgroundColor =
                "color-mix(in srgb, var(--pp-primary-fixed-dim) 20%, transparent)";
        ...
        <button
          ...
          style={{
            ...
            opacity:
              (!content.trim() && mediaUrls.length === 0) || isSubmitting || photoUploading
                ? 0.5
                : 1,
            cursor:
              (!content.trim() && mediaUrls.length === 0) || isSubmitting || photoUploading
