...
const topStudents = [
  {
    ...
    xp: "3,200 XP",
    initial: "DK",
    avatarColor: "var(--pp-primary-container)",
  },
  {
    rank: 2,
    name: "Anita Silva",
    xp: "2,950 XP",
    initial: "AS",
    avatarColor: "var(--pp-secondary-container)",
  },
  {
    rank: 3,
    name: "Omar Farooq",
    xp: "2,800 XP",
    initial: "OF",
    avatarColor: "var(--pp-tertiary-container)",
  },
];
          ...
          {topStudents.map((student) => (
            <div
              ...
              style={{
                borderLeft:
                  student.rank === 1
                    ? "2px solid var(--pp-secondary-container)"
            ...
            >
              <span
                ...
                style={{
                  color:
                    student.rank === 1
                      ? "var(--pp-secondary-container)"
                      : "var(--pp-on-surface-variant)",
                }}
              >
                {student.rank}
              </span>
              ...
              <span
                ...
                style={{ color: "var(--pp-secondary)", fontFamily: "var(--font-mono)" }}
              >
                {student.xp}
              </span>
            </div>
