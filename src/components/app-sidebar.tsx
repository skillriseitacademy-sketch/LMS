...
const TEACHER_NAV_ITEMS = [
  { to: "/teacher", icon: "school", label: "Teacher Hub" },
  { to: "/teacher/topics", icon: "menu_book", label: "Topics" },
  { to: "/teacher/quizzes", icon: "checklist", label: "Quizzes" },
  { to: "/teacher/live-classes", icon: "live_tv", label: "Live Classes" },
  { to: "/teacher/recorded-sessions", icon: "smart_display", label: "Recorded Sessions" },
  { to: "/teacher/projects", icon: "folder", label: "Projects" },
  { to: "/teacher/interviews", icon: "mic", label: "Interviews" },
];
...
const ADMIN_NAV_ITEMS = [
  ...
  { to: "/admin/jobs", icon: "work_history", label: "Job Aggregator" },
        ...
        <div className="px-5 pt-5 pb-3">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p
                className="text-[10px] font-medium text-on-surface-variant uppercase tracking-widest"
        ...
        <nav className="flex-1 px-3 py-2 space-y-0.5 overflow-y-auto">
          ...
          {(session?.role === "teacher" || session?.role === "admin") && (
            <>
              ...
              {TEACHER_NAV_ITEMS.map(({ to, icon, label }) => {
                const active = isActive(to);
                return (
                  <Link
                    key={to}
